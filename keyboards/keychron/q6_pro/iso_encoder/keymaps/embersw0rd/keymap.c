...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN] = LAYOUT_110_iso(
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  BAT_LVL,  RGB_VAD,  RGB_VAI,  _______,    _______,    _______,  _______,  TG (3),   _______,  _______,  _______,  _______,
